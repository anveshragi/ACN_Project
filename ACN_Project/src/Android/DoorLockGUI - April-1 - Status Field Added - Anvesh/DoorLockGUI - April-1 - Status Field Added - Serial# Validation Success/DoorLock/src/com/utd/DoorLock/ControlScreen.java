...
//                        System.out.println(clientThread.getStatus().toString());
//                    }
//                    if(clientThread != null && clientThread.getStatus().toString().equalsIgnoreCase("running"))
//                    {
//                        boolean flag = clientThread.cancel(true);
//                        System.out.println(" Thread Stopped ::::::::::::::::::::::::::::::::::::::::        " + flag);
//                        System.out.println(clientThread.getStatus().toString());
//                    }
                    clientThread = new ClientThread();
                    clientThread.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,"lock");
//                    clientThread.execute("lock");
