 ...
 */
public class OneTimeLoginScreen extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_onetimeuser_login);
    ...
    public class ClientThread extends AsyncTask<String, String, Void>{
        ...
        protected Void doInBackground(String... status) {
            ...
            try {
                ...
                if (status.length != 0) {
                    send_message = "android_validation:" + status[0] + ":" + status[1] + ":1";
                }
                ...
                while (true) {
                    ...
                    if (words[0].equals("PASS")) {
                        ...
                        Intent viewIntent = new Intent(getApplicationContext(), OneTimeUserControlScreen.class);
